  ...
  function renderConfigRegion() {
    var html = '<div class="ow-sec-h">' + esc(t('config')) + '</div>' +
      '<div class="ow-card ow-config">' +
        ...
        '<div class="ow-scan-row"><div class="ow-scan-btns"><button class="ow-btn" data-effort-scan="1" type="button">' + esc(t('effortScan')) + '</button><button class="ow-btn ow-btn-ghost" data-effort-force="1" type="button" title="' + esc(t('effortRescanHint')) + '">' + esc(t('effortRescan')) + '</button></div><div class="ow-hint">' + esc(t('effortScanHint')) + '</div></div>' +
