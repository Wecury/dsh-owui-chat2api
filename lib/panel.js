...
(function () {
  ...
  function cssText() {
    return (
      ...
      // minimal utility helpers (tailwind-ish layout vocabulary)
      '#dsh-owui-panel .ow-flex { display: flex; align-items: center; }' +
      '#dsh-owui-panel .ow-flex-col { display: flex; flex-direction: column; }' +
      '#dsh-owui-panel .ow-gap { gap: 8px; }' +
      '#dsh-owui-panel .ow-wrap { flex-wrap: wrap; }' +
      '#dsh-owui-panel .ow-between { justify-content: space-between; }' +
      '#dsh-owui-panel .ow-grow { flex: 1 1 auto; min-width: 0; }' +
      '#dsh-owui-panel .ow-mt { margin-top: 8px; }' +
      '#dsh-owui-panel .ow-end { justify-content: flex-end; }' +
      ...
      '#dsh-owui-panel .ow-status-actions { display: flex; gap: 8px; flex-wrap: wrap; margin-left: auto; }' +
      ...
      '#dsh-owui-panel .ow-note-tx { flex: 1; min-width: 0; word-break: break-word; white-space: pre-wrap; }' +
      ...
      '#dsh-owui-panel .ow-diag { display: flex; align-items: center; flex-wrap: wrap; gap: 6px 12px; font-size: 12px; }' +
      '#dsh-owui-panel .ow-diag-list { flex: 1; min-width: 0; display: flex; flex-wrap: wrap; gap: 4px 14px; }' +
      ...
      '#dsh-owui-panel .ow-diag-path { flex-basis: 100%; font-size: 11px; word-break: break-all; color: var(--dsw-alias-label-secondary, #9ca3af); }' +
      ...
      '#dsh-owui-panel .ow-switch-row { font-size: 12px; cursor: pointer; margin-top: 4px; color: var(--dsw-alias-label-primary); user-select: none; }' +
      ...
      '#dsh-owui-panel .ow-config-foot { margin-top: 14px; }' +
      ...
      '#dsh-owui-panel .ow-log summary { font-size: 12px; color: var(--dsw-alias-label-secondary, #9ca3af); cursor: pointer;' +
        ' padding: 9px 10px; border: 1px solid var(--dsw-alias-border-l1, rgba(128,128,128,.25)); border-radius: 8px;' +
      ...
      '#dsh-owui-panel .ow-log-btn { font: 500 11px/1 ui-monospace, SFMono-Regular, Menlo, monospace; padding: 4px 9px;' +
