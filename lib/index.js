...
// startup and re-probes in the background when the cache goes stale, so polling
// cannot stall the event loop. start/login also hand the probe off to a
// setImmediate instead of blocking a web handler for the full probe (~27s).
//
